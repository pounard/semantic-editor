 ...
 */
export  function setEndOfContenteditable(contentEditableElement: HTMLElement): void {
    let range, selection;
...
export function selectTabbablePrev(context: HTMLElement): void {
    ...
    if (first) {
        ...
        setEndOfContenteditable(<HTMLElement>first);
    }
}
